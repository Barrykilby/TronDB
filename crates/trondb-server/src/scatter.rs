...
mod tests {
    ...
    fn merge_dense_results_sorts_by_score() {
        ...
        let r2 = make_result(
            vec![
                make_row("C", "Charlie", Some(0.85)),
                make_row("D", "Delta", Some(0.6)),
            ],
            60,
        );
    ...
    fn merge_hybrid_results_uses_rrf() {
        ...
        let r1 = make_result(
            vec![
                make_row("X", "X-ray", Some(0.9)),
                make_row("Y", "Yankee", Some(0.8)),
            ],
            50,
        );
        ...
        let r2 = make_result(
            vec![
                make_row("Y", "Yankee", Some(0.95)),
                make_row("Z", "Zulu", Some(0.7)),
            ],
            60,
        );
    ...
    fn merge_dense_single_result_passthrough() {
        let r1 = make_result(vec![make_row("X", "X-ray", Some(0.5))], 42);
