...
impl PeerConfig {
    ...
    /// `"node-2:replica:192.0.2.11:9400,router-1:router:192.0.2.12:9400"`
    ///
...
"#;
    ...
    fn parse_peers_env_var() {
        let peers_str = "node-2:replica:192.0.2.11:9400,router-1:router:192.0.2.12:9400";
